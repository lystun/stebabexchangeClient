            ...
            <form role="form" @submit.prevent="submit">
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input type="email" v-model.trim="form.email" class="form-control" :class="{'is-invalid': errors.status }" id="input-email" placeholder="name@mail.com" autofocus>
                ...
                <div class="form-group mb-4">
                    ...
                    <div class="input-group input-group-merge">
                        ...
                        <input type="password" v-model.trim="form.password" class="form-control" id="input-password" placeholder="Password">
