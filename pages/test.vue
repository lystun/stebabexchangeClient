                            ...
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" v-model="form.fname" type="text" placeholder="First Name"  >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-control-label">Last name</label>
                                        <input class="form-control" v-model="form.lname" type="text" placeholder="Last name"  >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" v-model="form.email" type="email" placeholder="name@exmaple.com"  >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-control-label">Phone Number</label>
                                        <input class="form-control" v-model="form.phoneNumber" type="number" placeholder="+234 7770 245 1549"  >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" v-model="form.country" type="text" placeholder="Country"  >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-control-label">State</label>
                                        <input class="form-control" v-model="form.state" type="text" placeholder="State"  >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" v-model="form.digitalAsset"  >
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" v-model="form.amountSent" type="number" placeholder="Amount sent in USD"  >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" v-model="form.bankName">
                                            <option :value="bank.name" v-for="(bank, index) in allBanks" :key="index"  >
                                                {{bank.name}}
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" v-model="form.bankAccountName" type="text" placeholder="Account Holder Name"  >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-control-label">Bank Account Number </label>
                                        <input class="form-control" v-model="form.bankAccountNumber" type="number" placeholder="Account Number"  >
                                    </div>
                                </div>
                            </div>
        ...
        methods: {
            ...
            async create(){
                ...
                try {
                    ...
                    // await this.$axios.$post('transactions/send-mail', this.form)
                    await this.$axios.$post('transactions/create-new', this.form)
